...
int main()
{
    ...
    // -------------------------
    Shader shader("res/shaders/VertexPointShadow.shader", "res/shaders/FragmentPointShadow.shader");
    Shader depthShader("res/shaders/VertexPointShadowsDepth.shader", "res/shaders/FragmentPointShadowsDepth.shader", "res/shaders/GeometryPointShadowsDepth.shader");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //1. rendering scene to cube depthmap
        ...
        shader.SetUniform1f("far_plane", farPlane);
        texture.Bind(0);
