...
int main()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(cubeVertices) + sizeof(normals) + sizeof(textures), NULL, GL_STATIC_DRAW);

    glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(cubeVertices), &cubeVertices);
    glBufferSubData(GL_ARRAY_BUFFER, sizeof(cubeVertices), sizeof(normals), &normals);
    glBufferSubData(GL_ARRAY_BUFFER, sizeof(cubeVertices)+ sizeof(normals), sizeof(textures), &textures);
    ...
    glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, 2 * sizeof(float), (void*)(sizeof(cubeVertices) + sizeof(normals)));
